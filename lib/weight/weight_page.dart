...
class _WeightPageState extends State<WeightPage> {
          ...
          children: [
            ...
            Center(
              child: ElevatedButton(
                ...
                child: const Text("Add Today's Weight"),
              ),
            ),
            const SizedBox(height: 16),
            _buildWeightInfo(
  ...
  void _applyFilter(String filter) {
    ...
    switch (filter) {
      ...
      case '30 days':
        ...
        break;
      case '3 months':
        startDate = now.subtract(const Duration(days: 90)); // Last 3 months
        break;
      default:
  ...
  Widget _buildWeightInfo(String label, String value) {
    return Container(
      padding: const EdgeInsets.all(12), // Spacing within the container
